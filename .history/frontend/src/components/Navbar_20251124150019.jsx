      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          <Link to="/" className="text-3xl font-extrabold flex items-center gap-2 font-[Comic Sans MS,cursive]">
            <img src="https://static.wikia.nocookie.net/masya-i-medved/images/7/7e/Bear_Transparent.png" alt="Bear" className="w-10 h-10 rounded-full bg-white border-2 border-pink-200 shadow" />
            Миша
          </Link>
