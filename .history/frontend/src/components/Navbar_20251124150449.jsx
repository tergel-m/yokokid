      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          <Link to="/" className="text-3xl font-extrabold flex items-center gap-2 font-[Comic Sans MS,cursive]">
            <img src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.youtube.com%2Fchannel%2FUCu59yAFE8fM0sVNTipR4edw&psig=AOvVaw2mQNTgcGFrHfEIL5p5EKtn&ust=1764054121359000&source=images&cd=vfe&opi=89978449&ved=0CBQQjRxqFwoTCIiTk-2bipEDFQAAAAAdAAAAABAn" alt="Bear" className="w-10 h-10 rounded-full bg-white border-2 border-pink-200 shadow" />
            Миша
          </Link>
