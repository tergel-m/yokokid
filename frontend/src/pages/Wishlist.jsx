    ...
    return (
      <div className="min-h-screen bg-white dark:bg-gray-900 py-20">
        <div className="container mx-auto px-4 text-center">
          <svg className="w-32 h-32 mx-auto mb-8 text-gray-300 dark:text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8">Таны хадгалсан бүтээгдэхүүн байхгүй байна</p>
          <Link
            to="/products"
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {wishlist.map((product) => (
            <div key={product.id} className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 group relative">
              ...
              <div className="p-4">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="px-4 py-2 border border-gray-300 dark:border-gray-600 hover:border-black dark:hover:border-white dark:text-white"
                  >
